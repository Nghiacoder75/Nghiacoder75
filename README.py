...
cookie_fb=input("Nhap Cookie Facebook: ")
...
t33=requests.get("https://rpwliker.com/facebook/posts",headers=headers1).text
...
t3=requests.post("https://rpwliker.com/facebook/autoreaction",headers=hd,data=data).text
print(t3)
input()
